...
function filterPictogram(question) {
    ...
    if (questionSelected === 'Qu\'as-tu mangé ce matin?') { // Si la question sélectionnée correspond à telle chaîne de caractères
        categoryQuestion = ["Aliments", "Fruits et légumes"];   // Alors sélectionne les pictogrammes de ces categories
    ...
    } else if (questionSelected === 'Quel âge as-tu?') {
        ...
        categoryQuestion = ["Sujets", "Boissons", "Actions", "Adjectifs", "Aliments", "Animaux", "Chiffres", "Corps Humain", "Couleurs", "Déterminants", "Émotions", "Fruits et légumes", "Langue des signes", "Lieux", "Météo", "Multimédia", "Objets", "Personnes", "Scolarité", "Transports", "Vêtements"];
    }
