! function(e, t) {
  ...
  return function(e) {
	...
	}, a.p = "localhost:8080/dist/plugin/", a(a.s = 0)
  }([function(e, t, a) {
	"use strict";
	...
	var i = function() {
  	...
  	return n(e, null, [{
    	...
    	key: "updateCanvases",
    	value: function() {
      	for (var e, t = this, a = function() {
          	var e = t.canvases.pop();
          	e.parentElement.removeChild(e)
        	}, r = Math.round(this.drawer.wrapper.scrollWidth), n = Math.ceil(r / this.maxCanvasElementWidth); this.canvases.length < n;) e = void 0, e = t.wrapper.appendChild(document.createElement("canvas")), t.canvases.push(e), t.util.style(e, {
        	position: "absolute",
        	zIndex: 4
      	});
      	for (; this.canvases.length > n;) a()
    	}
  	}, {
    	...
    	value: function() {
      	...
      	if (!(t <= 0)) {
        	var a, r = this.wavesurfer.params,
          	...
          	m = 0,
          	y = [];
        	for (a = 0; a < i / p; a++) y.push([a, m, v]), m += p, v += c * p;
        	var w = function(e) {
        	...
        	this.setFillStyles(this.params.primaryColor), this.setFonts("".concat(n, "px ").concat(this.params.fontFamily)), this.setFillStyles(this.params.primaryFontColor), w(function(t, a, r) {
          	t % f == 0 && (e.fillRect(r, 0, 1, s), e.fillText(u(a, c), r + e.params.labelPadding * e.pixelRatio, s))
